      ...
      columns: [
         {
            ...
            class: "text-center",
            render: (data) => {
               const avatarPath = `media/${h.parse("avatar", data)}`;
               const avatarUrl = h.cdn(avatarPath);
               return `<img src="${avatarUrl}" alt="${h.parse("nama", data)}" class="img-fluid rounded-3 w-50px h-50px" />`;
            },
         },
         { data: "nama" },
         { data: "username" },
