...
abstract class BaseController extends Controller
{
   ...
   public function generateWebpackCss(): string
   {
      if (!$this->publish) {
         ...
         return link_tag(CDN_PATH . 'bundle/tugas-akhir/akademik/app.' . HASH_CSS . '.css');
      }
   }
   ...
   public function generateWebpackJs(): string
   {
      if (!$this->publish) {
         ...
         return script_tag(['type' => 'module', 'src' => CDN_PATH . 'bundle/tugas-akhir/akademik/app.' . HASH_JS . '.js']);
      }
   }
}
