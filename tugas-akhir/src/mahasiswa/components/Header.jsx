...
const Header = () => {
   ...
   return (
      <div id="kt_header" className="header align-items-stretch mb-5 mb-lg-10" style={headerStyle}>
               ...
               <div className="topbar d-flex align-items-stretch flex-shrink-0">
                  <Dropdown bsPrefix="d-flex align-items-center me-lg-n2 ms-1 ms-lg-3" align="end">
                     <Dropdown.Toggle as="div" bsPrefix="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px">
                        <img
                           className="h-30px w-30px rounded lozad"
                           data-src={`/mahasiswa/profile/avatar?name=avatar-placeholder.png`}
                           alt="avatar"
                        />
                     </Dropdown.Toggle>
                     <Dropdown.Menu
                        ...
                        <div className="menu-item px-3">
                           <div className="menu-content d-flex align-items-center px-3">
                              <div className="symbol symbol-50px me-5">
                                 <img alt="avatar" className="lozad" data-src={`/mahasiswa/profile/avatar?name=avatar-placeholder.png`} />
                              </div>
