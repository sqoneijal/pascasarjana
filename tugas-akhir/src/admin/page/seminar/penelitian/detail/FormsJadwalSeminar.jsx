...
const FormsJadwalSeminar = () => {
   ...
   const { openFormsJadwalSeminar, sk_penelitian, detailContent } = module;
   ...
   const submit = (e) => {
      e.preventDefault();
      const formData = {
         id_penelitian: h.parse("id_penelitian", sk_penelitian),
      ...
      fetch.then((res) => {
         ...
         dispatch(setModule({ ...module, openFormsJadwalSeminar: false, jadwal_seminar: data.content }));
         clearProps();
         h.dtReload();
      });
      fetch.finally(() => {
               ...
               <Card.Header className="pe-5">
                  <div className="card-title">
                     <div className="d-flex justify-content-center flex-column me-3">
                        <span className="fs-4 fw-bold text-gray-900 text-hover-primary me-1 lh-1">Perbaharui Jadwal Seminar</span>
                     </div>
                  </div>
