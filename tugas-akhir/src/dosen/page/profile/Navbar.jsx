            ...
            <div className="d-flex flex-wrap flex-sm-nowrap">
               <div className="me-7 mb-4">
                  <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                     <img alt={h.parse("nama", init)} src={`/dosen/profile/avatar?name=${h.parse("avatar", init)}`} />
                  </div>
               </div>
                     ...
                     <div className="d-flex flex-column">
                        ...
                        <div className="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                           <a href="#" className="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
                              <i className="ki-outline ki-profile-circle fs-4 me-1" /> {h.userRole(h.parse("role", init))}
                           </a>
                        ...
                        <div className="d-flex flex-wrap">
                           <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                              <div className="d-flex align-items-center">
                                 ...
                                 <div className="fs-2 fw-bold counted">100</div>
                              </div>
