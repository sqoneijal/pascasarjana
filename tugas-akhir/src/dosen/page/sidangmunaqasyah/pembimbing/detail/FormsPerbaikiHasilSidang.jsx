...
const FormsPerbaikiHasilSidang = () => {
   ...
   const submit = (e) => {
      ...
      setIsSubmit(true);
      const fetch = h.post(`/submitperbaikisidang`, formData);
      fetch.then((res) => {
         ...
         dispatch(
            setModule({ ...module, openFormsPerbaikiSidang: false, pembimbing: data.content, detailContent: { ...detailContent, status: 27 } })
         );
         clearProps();
         h.dtReload();
      });
...
export default FormsPerbaikiHasilSidang;
