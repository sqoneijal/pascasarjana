...
const FormsPembimbing = () => {
   ...
   const { openFormsPembimbing, pageType, daftarKategoriKegiatan, detailContent, detailPembimbing } = module;
   ...
   const submit = (e) => {
      ...
      fetch.then((res) => {
         ...
         dispatch(setModule({ ...module, openFormsPembimbing: false, pageType: "", detailPembimbing: {}, pembimbingSeminarProposal: data.content }));
         clearProps();
         h.dtReload();
      });
      fetch.finally(() => {
